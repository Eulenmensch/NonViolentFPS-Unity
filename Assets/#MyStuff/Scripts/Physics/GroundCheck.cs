...
namespace NonViolentFPS.Physics
{
    public class GroundCheck : MonoBehaviour
    {
        ...
        public bool IsGrounded()
        {
            ...
            RaycastHit hit;
            bool ray = UnityEngine.Physics.Raycast( transform.position, DownDirection, out hit, GroundRayLength, GroundMask );
        ...
        public bool IsGrounded(Vector3 _rayOrigin)
        {
            ...
            RaycastHit hit;
            bool ray = UnityEngine.Physics.Raycast( _rayOrigin, DownDirection, out hit, GroundRayLength, GroundMask );
            if ( ray && CheckMaxAngle( hit.normal, MaxSlopeAngle ) )
            {
                return true;
            }
