...
public class HoverEffect : MonoBehaviour,IHitscanEffect
{
    ...
    private void ApplyGroundStickForce()
    {
	    ...
	    if ( stickToGround)
	    {
		    if ( Physics.Raycast( groundStickRay, out var hit, groundStickHeight, groundMask ) )
		    {
    ...
    {
	    RaycastHit hit;
	    bool ray = Physics.Raycast( _hoverPointPosition, -transform.up, out hit, hoverHeight, groundMask, QueryTriggerInteraction.Ignore );
	    _hit = hit;
	    return ray;
    }
